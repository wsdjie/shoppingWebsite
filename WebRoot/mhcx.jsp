...
<%@page import="com.taobao.servlet.queryServlet"%>
<%
...
int pageIndex = request.getParameter("pageIndex") == null ? 1 : Integer.parseInt(request.getParameter("pageIndex"));
	...
	List<GoodsInfo> list=(List<GoodsInfo>)request.getAttribute("pi");
%>
...
<html>
	...
	function first(){
		...
		var url = "<%=basePath%>mhcx.jsp?pageIndex="+pageIndex+"&typeId="+typeId;
